...
Component that was made reactive: `,
  ...
  var Popup_default = {
    ...
    setup(__props, { expose: __expose }) {
      ...
      const manifest = define_manifest_default;
      onMounted(() => {
  ...
  var _hoisted_4 = { class: "text-[10px] font-bold uppercase tracking-tighter text-zinc-400" };
  var _hoisted_5 = { class: "text-[9px] font-medium px-1.5 py-0.5 rounded bg-zinc-800 text-zinc-500 uppercase" };
  var _hoisted_6 = { class: "space-y-1.5" };
    ...
    return openBlock(), createElementBlock("div", _hoisted_1, [
      createBaseVNode("div", _hoisted_2, [
        createBaseVNode("div", _hoisted_3, [
          createBaseVNode(
            "div",
            {
              class: normalizeClass(["w-2 h-2 rounded-full transition-all duration-500", $setup.isEnabled ? "bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.6)]" : "bg-zinc-600"])
            },
            null,
            2
            /* CLASS */
          ...
          createBaseVNode(
            "span",
            _hoisted_4,
            " Devflow " + toDisplayString($setup.manifest.version),
            1
            /* TEXT */
          )
        ]),
        createBaseVNode(
          "span",
          _hoisted_5,
          toDisplayString($setup.isEnabled ? "Active" : "Offline"),
          1
          /* TEXT */
        )
      ]),
      createBaseVNode("div", _hoisted_6, [
        _cache[1] || (_cache[1] = createBaseVNode(
          ...
          {
            for: "port",
            class: "text-[10px] text-zinc-500 font-semibold uppercase ml-0.5"
          },
          "Proxy Port",
          -1
          /* CACHED */
        ...
        withDirectives(createBaseVNode("input", {
          id: "port",
          type: "number",
          "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => $setup.port = $event),
          disabled: $setup.isEnabled,
          ...
          [vModelText, $setup.port]
        ])
      ]),
      createBaseVNode("button", {
        onClick: $setup.toggleConnection,
        disabled: $setup.isProcessing,
        class: normalizeClass(["w-full text-xs font-bold py-2.5 rounded transition-all shadow-lg active:translate-y-[1px] disabled:opacity-50", $setup.isEnabled ? "bg-zinc-800 hover:bg-zinc-700 text-zinc-300 border border-zinc-700" : "bg-blue-600 hover:bg-blue-500 text-white shadow-blue-900/20"])
      }, [
        $setup.isProcessing ? (openBlock(), createElementBlock("span", _hoisted_9, "Processing...")) : (openBlock(), createElementBlock(
          "span",
          _hoisted_10,
          toDisplayString($setup.isEnabled ? "Disconnect" : "Connect to Designer"),
          1
          /* TEXT */
        ))
      ], 10, _hoisted_8)
  ...
  createApp(Popup_default2).mount("#app");
})();
