...
<template>
  <div
    class="flex flex-col gap-4 w-[220px] p-4 bg-zinc-900 text-zinc-100 antialiased border border-zinc-800 rounded-lg"
  >
    <div class="flex items-center justify-between">
      <div class="flex items-center gap-2">
        ...
        ></div>
        <span
          class="text-[10px] font-bold uppercase tracking-tighter text-zinc-400"
        >
          Peakflow {{ manifest.version }}
        </span>
      </div>
      <span
        class="text-[9px] font-medium px-1.5 py-0.5 rounded bg-zinc-800 text-zinc-500 uppercase"
      >
